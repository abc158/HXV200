...
#define DOCK_CLOSE_BEACON 0xC5//座子信号
#define LEFT_BEACON_BYTE 0xA6//座子信号
#define RIGHT_BEACON_BYTE 0x59//座子信号
#define BOTH_BEACONS_BYTE 0xFC//座子信号
...
{
  IR_LOCAL_MID_LEFT,//0
  IR_LOCAL_MID_RIGHT,//1
  IR_LOCAL_LEFT,//2
  IR_LOCAL_RIGHT,//3
  IR_LOCAL_BACK_LEFT,//4
  IR_LOCAL_BACK_RIGHT,//5
  IR_LOCAL_MAX
}IR_local_Index;
